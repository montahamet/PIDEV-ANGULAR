! function(e, a) {
    ...
    function c(e, a) {
        var t, s, n;
        if (d(a._isAMomentObject) || (e._isAMomentObject = a._isAMomentObject), d(a._i) || (e._i = a._i), d(a._f) || (e._f = a._f), d(a._l) || (e._l = a._l), d(a._strict) || (e._strict = a._strict), d(a._tzm) || (e._tzm = a._tzm), d(a._isUTC) || (e._isUTC = a._isUTC), d(a._offset) || (e._offset = a._offset), d(a._pf) || (e._pf = l(a)), d(a._locale) || (e._locale = a._locale), L.length > 0)
            for (t = 0; t < L.length; t++) d(n = a[s = L[t]]) || (e[s] = n);
        return e
    }
    var Y = !1;
    ...
    function b(e, a) {
        var t, s = m({}, e);
        for (t in a) o(a, t) && (n(e[t]) && n(a[t]) ? (s[t] = {}, m(s[t], e[t]), m(s[t], a[t])) : null != a[t] ? s[t] = a[t] : delete s[t]);
        for (t in e) o(e, t) && !o(a, t) && n(e[t]) && (s[t] = m({}, s[t]));
        return s
    }
    ...
    function W(e) {
        var a, t, s = {};
        for (t in e) o(e, t) && (a = P(t)) && (s[a] = e[t]);
        return s
    }
    var A = {};
    ...
    function I(e, a) {
        return e.isValid() ? (a = U(a, e.localeData()), N[a] = N[a] || function(e) {
            ...
            for (a = 0, t = n.length; a < t; a++) R[n[a]] ? n[a] = R[n[a]] : n[a] = (s = n[a]).match(/\[[\s\S]/) ? s.replace(/^\[|\]$/g, "") : s.replace(/\\/g, "");
            return function(a) {
                var s, d = "";
                for (s = 0; s < t; s++) d += H(n[s]) ? n[s].call(a, e) : n[s];
                return d
            }
    ...
    function U(e, a) {
        ...
        for (J.lastIndex = 0; t >= 0 && J.test(e);) e = e.replace(J, s), J.lastIndex = 0, t -= 1;
        return e
    }
    var G = /\d/,
        V = /\d\d/,
    ...
    function ie(e, a, t) {
        _e[e] = H(a) ? a : function(e, s) {
            return e && t ? t : a
        }
    }

    function oe(e, a) {
        return o(_e, e) ? _e[e](a._strict, a._locale) : new RegExp(me(e.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function(e, a, t, s, n) {
            return a || t || s || n
        })))
    }
    ...
    }), C(0, ["YYYY", 4], 0, "year"), C(0, ["YYYYY", 5], 0, "year"), C(0, ["YYYYYY", 6, !0], 0, "year"), O("year", "y"), E("year", 1), ie("Y", se), ie("YY", B, V), ie("YYYY", ee, Z), ie("YYYYY", ae, $), ie("YYYYYY", ae, $), le(["YYYYY", "YYYYYY"], Le), le("YYYY", function(e, a) {
        a[Le] = 2 === e.length ? t.parseTwoDigitYear(e) : k(e)
    }), le("YY", function(e, a) {
        a[Le] = t.parseTwoDigitYear(e)
    }), le("Y", function(e, a) {
        a[Le] = parseInt(e, 10)
    }), t.parseTwoDigitYear = function(e) {
        return k(e) + (k(e) > 68 ? 1900 : 2e3)
    };
    var ve, Se = He("FullYear", !0);

    function He(e, a) {
        return function(s) {
            return null != s ? (je(this, e, s), t.updateOffset(this, a), this) : be(this, e)
        }
    }
    ...
    function je(e, a, t) {
        e.isValid() && !isNaN(t) && ("FullYear" === a && we(e.year()) && 1 === e.month() && 29 === e.date() ? e._d["set" + (e._isUTC ? "UTC" : "") + a](t, e.month(), xe(t, e.month())) : e._d["set" + (e._isUTC ? "UTC" : "") + a](t))
    }

    function xe(e, a) {
        if (isNaN(e) || isNaN(a)) return NaN;
        var t, s = (a % (t = 12) + t) % t;
        return e += (a - s) / 12, 1 === s ? we(e) ? 29 : 28 : 31 - s % 7 % 2
    }
    ve = Array.prototype.indexOf ? Array.prototype.indexOf : function(e) {
        ...
        null != n ? a[ce] = n : l(t).invalidMonth = e
    });
    var Oe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
    ...
    function Ae(e, a) {
        ...
        return t = Math.min(e.date(), xe(e.year(), a)), e._d["set" + (e._isUTC ? "UTC" : "") + "Month"](a, t), e
    }

    function Ee(e) {
        return null != e ? (Ae(this, e), t.updateOffset(this, !0), this) : be(this, "Month")
    }
    var Fe = re;
    var ze = re;
    ...
    function Ce(e, a, t, s, n) {
        var d, r, _ = 1 + 7 * (a - 1) + (7 + t - s) % 7 + Re(e, s, n);
        return _ <= 0 ? r = ge(d = e - 1) + _ : _ > ge(e) ? (d = e + 1, r = _ - ge(e)) : (d = e, r = _), {
            year: d,
            dayOfYear: r
        }
    }
    ...
    function Ie(e, a, t) {
        ...
        return r < 1 ? s = r + Ue(n = e.year() - 1, a, t) : r > Ue(e.year(), a, t) ? (s = r - Ue(e.year(), a, t), n = e.year() + 1) : (n = e.year(), s = r), {
            week: s,
            year: n
        }
    }
    ...
    C("H", ["HH", 2], 0, "hour"), C("h", ["hh", 2], 0, Xe), C("k", ["kk", 2], 0, function() {
        ...
        return "" + Xe.apply(this) + F(this.minutes(), 2)
    }), C("hmmss", 0, 0, function() {
        return "" + Xe.apply(this) + F(this.minutes(), 2) + F(this.seconds(), 2)
    }), C("Hmm", 0, 0, function() {
        return "" + this.hours() + F(this.minutes(), 2)
    }), C("Hmmss", 0, 0, function() {
        return "" + this.hours() + F(this.minutes(), 2) + F(this.seconds(), 2)
    }), ea("a", !0), ea("A", !1), O("hour", "h"), E("hour", 13), ie("a", aa), ie("A", aa), ie("H", B), ie("h", B), ie("k", B), ie("HH", B, V), ie("hh", B, V), ie("kk", B, V), ie("hmm", q), ie("hmmss", Q), ie("Hmm", q), ie("Hmmss", Q), le(["H", "HH"], ye), le(["k", "kk"], function(e, a, t) {
        var s = k(e);
        a[ye] = 24 === s ? 0 : s
        ...
        var s = e.length - 2;
        a[ye] = k(e.substr(0, s)), a[fe] = k(e.substr(s)), l(t).bigHour = !0
    }), le("hmmss", function(e, a, t) {
        var s = e.length - 4,
            n = e.length - 2;
        a[ye] = k(e.substr(0, s)), a[fe] = k(e.substr(s, 2)), a[pe] = k(e.substr(n)), l(t).bigHour = !0
    }), le("Hmm", function(e, a, t) {
        var s = e.length - 2;
        a[ye] = k(e.substr(0, s)), a[fe] = k(e.substr(s))
    }), le("Hmmss", function(e, a, t) {
        var s = e.length - 4,
            n = e.length - 2;
        a[ye] = k(e.substr(0, s)), a[fe] = k(e.substr(s, 2)), a[pe] = k(e.substr(n))
    });
    var ta, sa = He("Hours", !0),
        na = {
            calendar: {
                sameDay: "[Today at] LT",
    ...
    function ia(e) {
        var a = null;
        if (!da[e] && "undefined" != typeof module && module && module.exports) try {
            a = ta._abbr, require("./locale/" + e), oa(a)
        } catch (e) {}
        return da[e]
    }
    ...
    function oa(e, a) {
        var t;
        return e && ((t = d(a) ? ua(e) : ma(e, a)) ? ta = t : "undefined" != typeof console && console.warn && console.warn("Locale " + e + " not found. Did you forget to load it?")), ta._abbr
    }

    function ma(e, a) {
        if (null !== a) {
            var t, s = na;
            if (a.abbr = e, null != da[e]) S("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), s = da[e]._config;
            else if (null != a.parentLocale)
                if (null != da[a.parentLocale]) s = da[a.parentLocale]._config;
                else {
            ...
            return da[e] = new j(b(s, a)), ra[e] && ra[e].forEach(function(e) {
                ma(e.name, e.config)
            }), oa(e), da[e]
        }
    ...
    function ua(e) {
        ...
        return function(e) {
            for (var a, t, s, n, d = 0; d < e.length;) {
                for (a = (n = _a(e[d]).split("-")).length, t = (t = _a(e[d + 1])) ? t.split("-") : null; a > 0;) {
    ...
    function la(e) {
        var a, t = e._a;
        return t && -2 === l(e).overflow && (a = t[ce] < 0 || t[ce] > 11 ? ce : t[Ye] < 1 || t[Ye] > xe(t[Le], t[ce]) ? Ye : t[ye] < 0 || t[ye] > 24 || 24 === t[ye] && (0 !== t[fe] || 0 !== t[pe] || 0 !== t[ke]) ? ye : t[fe] < 0 || t[fe] > 59 ? fe : t[pe] < 0 || t[pe] > 59 ? pe : t[ke] < 0 || t[ke] > 999 ? ke : -1, l(e)._overflowDayOfYear && (a < Le || a > Ye) && (a = Ye), l(e)._overflowWeeks && -1 === a && (a = De), l(e)._overflowWeekday && -1 === a && (a = Te), l(e).overflow = a), e
    }
    ...
    function ha(e) {
        ...
        if (!e._d) {
            for (n = function(e) {
                ...
                }(e), e._w && null == e._a[Ye] && null == e._a[ce] && function(e) {
                    var a, t, s, n, d, r, _, i;
                    if (null != (a = e._w).GG || null != a.W || null != a.E) d = 1, r = 4, t = Ma(a.GG, e._a[Le], Ie(ba(), 1, 4).year), s = Ma(a.W, 1), ((n = Ma(a.E, 1)) < 1 || n > 7) && (i = !0);
                    else {
                        d = e._locale._week.dow, r = e._locale._week.doy;
                        var o = Ie(ba(), d, r);
                        t = Ma(a.gg, e._a[Le], o.year), s = Ma(a.w, o.week), null != a.d ? ((n = a.d) < 0 || n > 6) && (i = !0) : null != a.e ? (n = a.e + d, (a.e < 0 || a.e > 6) && (i = !0)) : n = d
                    }
                    s < 1 || s > Ue(t, d, r) ? l(e)._overflowWeeks = !0 : null != i ? l(e)._overflowWeekday = !0 : (_ = Ce(t, s, n, d, r), e._a[Le] = _.year, e._dayOfYear = _.dayOfYear)
                }(e), null != e._dayOfYear && (r = Ma(e._a[Le], n[Le]), (e._dayOfYear > ge(r) || 0 === e._dayOfYear) && (l(e)._overflowDayOfYear = !0), s = Ne(r, 0, e._dayOfYear), e._a[ce] = s.getUTCMonth(), e._a[Ye] = s.getUTCDate()), a = 0; a < 3 && null == e._a[a]; ++a) e._a[a] = _[a] = n[a];
            for (; a < 7; a++) e._a[a] = _[a] = null == e._a[a] ? 2 === a ? 1 : 0 : e._a[a];
            24 === e._a[ye] && 0 === e._a[fe] && 0 === e._a[pe] && 0 === e._a[ke] && (e._nextDay = !0, e._a[ye] = 0), e._d = (e._useUTC ? Ne : function(e, a, t, s, n, d, r) {
                var _;
                return e < 100 && e >= 0 ? (_ = new Date(e + 400, a, t, s, n, d, r), isFinite(_.getFullYear()) && _.setFullYear(e)) : _ = new Date(e, a, t, s, n, d, r), _
            }).apply(null, _), d = e._useUTC ? e._d.getUTCDay() : e._d.getDay(), null != e._tzm && e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), e._nextDay && (e._a[ye] = 24), e._w && void 0 !== e._w.d && e._w.d !== d && (l(e).weekdayMismatch = !0)
        }
    }
    ...
    function ka(e) {
        ...
        if (i) {
            ...
            if (i[4]) {
                if (!Ya.exec(i[4])) return void(e._isValid = !1);
                r = "Z"
            }
            e._f = n + (d || "") + (r || ""), va(e)
        } else e._isValid = !1
    }
    var Da = /^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/;
    ...
    function wa(e) {
        var a, t, s, n, d, r, _, i = Da.exec(e._i.replace(/\([^)]*\)|[\n\t]/g, " ").replace(/(\s\s+)/g, " ").replace(/^\s\s*/, "").replace(/\s\s*$/, ""));
        if (i) {
            var o = (a = i[4], t = i[3], s = i[2], n = i[5], d = i[6], r = i[7], _ = [Ta(a), We.indexOf(t), parseInt(s, 10), parseInt(n, 10), parseInt(d, 10)], r && _.push(parseInt(r, 10)), _);
            if (! function(e, a, t) {
                    return !e || Ke.indexOf(e) === new Date(a[0], a[1], a[2]).getDay() || (l(t).weekdayMismatch = !0, t._isValid = !1, !1)
                }(i[1], o, e)) return;
            e._a = o, e._tzm = function(e, a, t) {
                if (e) return ga[e];
                if (a) return 0;
                var s = parseInt(t, 10),
                    n = s % 100;
                return (s - n) / 100 * 60 + n
            }(i[8], i[9], i[10]), e._d = Ne.apply(null, e._a), e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), l(e).rfc2822 = !0
        } else e._isValid = !1
    }
    ...
    function va(e) {
        if (e._f !== t.ISO_8601)
            if (e._f !== t.RFC_2822) {
                e._a = [], l(e).empty = !0;
                var a, s, n, d, r, _ = "" + e._i,
                    i = _.length,
                    o = 0;
                for (n = U(e._f, e._locale).match(z) || [], a = 0; a < n.length; a++) d = n[a], (s = (_.match(oe(d, e)) || [])[0]) && ((r = _.substr(0, _.indexOf(s))).length > 0 && l(e).unusedInput.push(r), _ = _.slice(_.indexOf(s) + s.length), o += s.length), R[d] ? (s ? l(e).empty = !1 : l(e).unusedTokens.push(d), he(d, s, e)) : e._strict && !s && l(e).unusedTokens.push(d);
                l(e).charsLeftOver = i - o, _.length > 0 && l(e).unusedInput.push(_), e._a[ye] <= 12 && !0 === l(e).bigHour && e._a[ye] > 0 && (l(e).bigHour = void 0), l(e).parsedDateParts = e._a.slice(0), l(e).meridiem = e._meridiem, e._a[ye] = function(e, a, t) {
                    var s;
                    if (null == t) return a;
                    return null != e.meridiemHour ? e.meridiemHour(a, t) : null != e.isPM ? ((s = e.isPM(t)) && a < 12 && (a += 12), s || 12 !== a || (a = 0), a) : a
                }(e._locale, e._a[ye], e._meridiem), ha(e), la(e)
            } else wa(e);
        else ka(e)
    }
    ...
    function Sa(e) {
        var a = e._i,
            o = e._f;
        return e._locale = e._locale || ua(e._l), null === a || void 0 === o && "" === a ? h({
            nullInput: !0
        }) : ("string" == typeof a && (e._i = a = e._locale.preparse(a)), f(a) ? new y(la(a)) : (_(a) ? e._d = a : s(o) ? function(e) {
            var a, t, s, n, d;
            if (0 === e._f.length) return l(e).invalidFormat = !0, void(e._d = new Date(NaN));
            for (n = 0; n < e._f.length; n++) d = 0, a = c({}, e), null != e._useUTC && (a._useUTC = e._useUTC), a._f = e._f[n], va(a), M(a) && (d += l(a).charsLeftOver, d += 10 * l(a).unusedTokens.length, l(a).score = d, (null == s || d < s) && (s = d, t = a));
            m(e, t || a)
        }(e) : o ? va(e) : function(e) {
            var a = e._i;
            d(a) ? e._d = new Date(t.now()) : _(a) ? e._d = new Date(a.valueOf()) : "string" == typeof a ? function(e) {
                var a = pa.exec(e._i);
                null === a ? (ka(e), !1 === e._isValid && (delete e._isValid, wa(e), !1 === e._isValid && (delete e._isValid, t.createFromInputFallback(e)))) : e._d = new Date(+a[1])
            }(e) : s(a) ? (e._a = i(a.slice(0), function(e) {
    ...
    function Ha(e, a, t, d, r) {
        ...
        return !0 !== t && !1 !== t || (d = t, t = void 0), (n(e) && function(e) {
            ...
            return !0
        }(e) || s(e) && 0 === e.length) && (e = void 0), i._isAMomentObject = !0, i._useUTC = i._isUTC = r, i._l = t, i._i = e, i._f = a, i._strict = d, (_ = new y(la(Sa(i))))._nextDay && (_.add(1, "d"), _._nextDay = void 0), _
    }
    ...
    var ja = g("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
            var e = ba.apply(null, arguments);
            return this.isValid() && e.isValid() ? e < this ? this : e : h()
        }),
        xa = g("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
            var e = ba.apply(null, arguments);
            return this.isValid() && e.isValid() ? e > this ? this : e : h()
        });
    ...
    function Oa(e, a) {
        var t, n;
        if (1 === a.length && s(a[0]) && (a = a[0]), !a.length) return ba();
    ...
    function Wa(e) {
        ...
        this._isValid = function(e) {
            for (var a in e)
                if (-1 === ve.call(Pa, a) || null != e[a] && isNaN(e[a])) return !1;
            for (var t = !1, s = 0; s < Pa.length; ++s)
                if (e[Pa[s]]) {
                    if (t) return !1;
                    parseFloat(e[Pa[s]]) !== k(e[Pa[s]]) && (t = !0)
                }
            return !0
        }(a), this._milliseconds = +m + 1e3 * o + 6e4 * i + 1e3 * _ * 60 * 60, this._days = +r + 7 * d, this._months = +n + 3 * s + 12 * t, this._data = {}, this._locale = ua(), this._bubble()
    }
    ...
    Fa("Z", ":"), Fa("ZZ", ""), ie("Z", de), ie("ZZ", de), le(["Z", "ZZ"], function(e, a, t) {
        t._useUTC = !0, t._tzm = Ja(de, e)
    });
    var za = /([\+\-]|\d\d)/gi;
    ...
    function Na(e, a) {
        var s, n;
        return a._isUTC ? (s = a.clone(), n = (f(e) || _(e) ? e.valueOf() : ba(e).valueOf()) - s.valueOf(), s._d.setTime(s._d.valueOf() + n), t.updateOffset(s, !1), s) : ba(e).local()
    }
    ...
    function Ga(e, a) {
        ...
        return Aa(e) ? d = {
            ...
            d: e._days,
            M: e._months
        } : r(e) ? (d = {}, a ? d[a] = e : d.milliseconds = e) : (_ = Ia.exec(e)) ? (t = "-" === _[1] ? -1 : 1, d = {
            y: 0,
            d: k(_[Ye]) * t,
            h: k(_[ye]) * t,
            m: k(_[fe]) * t,
            ...
            a = Na(a, e), e.isBefore(a) ? t = Ka(e, a) : ((t = Ka(a, e)).milliseconds = -t.milliseconds, t.months = -t.months);
            return t
        }(ba(d.from), ba(d.to)), (d = {}).ms = n.milliseconds, d.M = n.months), s = new Wa(d), Aa(e) && o(e, "_locale") && (s._locale = e._locale), s
    }
    ...
    function Za(e, a) {
        return function(t, s) {
            var n;
            return null === s || isNaN(+s) || (S(a, "moment()." + a + "(period, number) is deprecated. Please use moment()." + a + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), n = t, t = s, s = n), $a(this, Ga(t = "string" == typeof t ? +t : t, s), e), this
        }
    }
    ...
    function $a(e, a, s, n) {
        var d = a._milliseconds,
            r = Ea(a._days),
            _ = Ea(a._months);
        e.isValid() && (n = null == n || n, _ && Ae(e, be(e, "Month") + _ * s), r && je(e, "Date", be(e, "Date") + r * s), d && e._d.setTime(e._d.valueOf() + d * s), n && t.updateOffset(e, r || _))
    }
    ...
    var et = g("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", function(e) {
    ...
    function _t(e, a, t) {
        return e < 100 && e >= 0 ? new Date(e + 400, a, t) - dt : new Date(e, a, t).valueOf()
    }

    function it(e, a, t) {
        return e < 100 && e >= 0 ? Date.UTC(e + 400, a, t) - dt : Date.UTC(e, a, t)
    }
    ...
    function mt(e, a, t, s, n) {
        var d;
        return null == e ? Ie(this, s, n).year : (a > (d = Ue(e, s, n)) && (a = d), function(e, a, t, s, n) {
            var d = Ce(e, a, t, s, n),
    ...
    }), ot("gggg", "weekYear"), ot("ggggg", "weekYear"), ot("GGGG", "isoWeekYear"), ot("GGGGG", "isoWeekYear"), O("weekYear", "gg"), O("isoWeekYear", "GG"), E("weekYear", 1), E("isoWeekYear", 1), ie("G", se), ie("g", se), ie("GG", B, V), ie("gg", B, V), ie("GGGG", ee, Z), ie("gggg", ee, Z), ie("GGGGG", ae, $), ie("ggggg", ae, $), Me(["gggg", "ggggg", "GGGG", "GGGGG"], function(e, a, t, s) {
        a[s.substr(0, 2)] = k(e)
    ...
    C("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), O("dayOfYear", "DDD"), E("dayOfYear", 4), ie("DDD", X), ie("DDDD", K), le(["DDD", "DDDD"], function(e, a, t) {
        t._dayOfYear = k(e)
    }), C("m", ["mm", 2], 0, "minute"), O("minute", "m"), E("minute", 14), ie("m", B), ie("mm", B, V), le(["m", "mm"], fe);
    var lt = He("Minutes", !1);
    C("s", ["ss", 2], 0, "second"), O("second", "s"), E("second", 15), ie("s", B), ie("ss", B, V), le(["s", "ss"], pe);
    var Mt, ht = He("Seconds", !1);
    for (C("S", 0, 0, function() {
        ...
        }), O("millisecond", "ms"), E("millisecond", 16), ie("S", X, G), ie("SS", X, V), ie("SSS", X, K), Mt = "SSSS"; Mt.length <= 9; Mt += "S") ie(Mt, te);

    function Lt(e, a) {
        a[ke] = k(1e3 * ("0." + e))
    }
    for (Mt = "S"; Mt.length <= 9; Mt += "S") le(Mt, Lt);
    var ct = He("Milliseconds", !1);
    ...
    Yt.add = Ba, Yt.calendar = function(e, a) {
        var s = e || ba(),
            n = Na(s, this).startOf("day"),
            d = t.calendarFormat(this, n) || "sameElse",
            r = a && (H(a[d]) ? a[d].call(this, s) : a[d]);
        return this.format(r || this.localeData().calendar(d, this, ba(s)))
    }, Yt.clone = function() {
        return new y(this)
    }, Yt.diff = function(e, a, t) {
        var s, n, d;
        if (!this.isValid()) return NaN;
        if (!(s = Na(e, this)).isValid()) return NaN;
        ...
        switch (e) {
            ...
            case "date":
                ...
                break;
            case "hour":
                a = this._d.valueOf(), a += nt - rt(a + (this._isUTC ? 0 : this.utcOffset() * st), nt) - 1;
                break;
            case "minute":
                a = this._d.valueOf(), a += st - rt(a, st) - 1;
                break;
            case "second":
                a = this._d.valueOf(), a += tt - rt(a, tt) - 1
        }
        ...
        return this.isValid() && (f(e) && e.isValid() || ba(e).isValid()) ? Ga({
            to: this,
            from: e
        ...
        return M(this)
    }, Yt.lang = et, Yt.locale = Xa, Yt.localeData = at, Yt.max = xa, Yt.min = ja, Yt.parsingFlags = function() {
        return m({}, l(this))
    }, Yt.set = function(e, a) {
        if ("object" == typeof e)
        ...
        switch (e) {
            ...
            case "date":
                ...
                break;
            case "hour":
                a = this._d.valueOf(), a -= rt(a + (this._isUTC ? 0 : this.utcOffset() * st), nt);
                break;
            case "minute":
                a = this._d.valueOf(), a -= rt(a, st);
                break;
            case "second":
                a = this._d.valueOf(), a -= rt(a, tt)
        }
        return this._d.setTime(a), t.updateOffset(this, !0), this
    }, Yt.subtract = qa, Yt.toArray = function() {
        var e = this;
        ...
        return t.year() < 0 || t.year() > 9999 ? I(t, a ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : H(Date.prototype.toISOString) ? a ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", I(t, "Z")) : I(t, a ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ")
    }, Yt.inspect = function() {
    ...
    }, Yt.year = Se, Yt.isLeapYear = function() {
        return we(this.year())
    ...
    }, Yt.date = ut, Yt.day = Yt.days = function(e) {
        ...
        return null == e ? a : this.add(e - a, "d")
    }, Yt.hour = Yt.hours = sa, Yt.minute = Yt.minutes = lt, Yt.second = Yt.seconds = ht, Yt.millisecond = Yt.milliseconds = ct, Yt.utcOffset = function(e, a, s) {
        var n, d = this._offset || 0;
        if (!this.isValid()) return null != e ? this : NaN;
        if (null != e) {
            if ("string" == typeof e) {
                if (null === (e = Ja(de, e))) return this
            } else Math.abs(e) < 16 && !s && (e *= 60);
            return !this._isUTC && a && (n = Ra(this)), this._offset = e, this._isUTC = !0, null != n && this.add(n, "m"), d !== e && (!a || this._changeInProgress ? $a(this, Ga(e - d, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, t.updateOffset(this, !0), this._changeInProgress = null)), this
        }
        return this._isUTC ? d : Ra(this)
    }, Yt.utc = function(e) {
    ...
    }, Yt.dates = g("dates accessor is deprecated. Use date instead.", ut), Yt.months = g("months accessor is deprecated. Use month instead", Ee), Yt.years = g("years accessor is deprecated. Use year instead", Se), Yt.zone = g("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function(e, a) {
        return null != e ? ("string" != typeof e && (e = -e), this.utcOffset(e, a), this) : -this.utcOffset()
    }), Yt.isDSTShifted = g("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", function() {
        if (!d(this._isDSTShifted)) return this._isDSTShifted;
        var e = {};
        if (c(e, this), (e = Sa(e))._a) {
            var a = e._isUTC ? u(e._a) : ba(e._a);
            this._isDSTShifted = this.isValid() && D(e._a, a.toArray()) > 0
    ...
    function kt(e, a, t) {
        if (r(e) && (a = e, e = void 0), e = e || "", null != a) return pt(e, a, t, "month");
        var s, n = [];
        for (s = 0; s < 12; s++) n[s] = pt(e, s, t, "month");
        return n
    }
    ...
    function Dt(e, a, t, s) {
        ...
        var n, d = ua(),
            _ = e ? d._week.dow : 0;
        if (null != t) return pt(a, (t + _) % 7, s, "day");
        var i = [];
        for (n = 0; n < 7; n++) i[n] = pt(a, (n + _) % 7, s, "day");
        return i
    }
    ft.calendar = function(e, a, t) {
        var s = this._calendar[e] || this._calendar.sameElse;
        return H(s) ? s.call(a, t) : s
    }, ft.longDateFormat = function(e) {
        var a = this._longDateFormat[e],
            t = this._longDateFormat[e.toUpperCase()];
        return a || !t ? a : (this._longDateFormat[e] = t.replace(/MMMM|MM|DD|dddd/g, function(e) {
            return e.slice(1)
        }), this._longDateFormat[e])
    }, ft.invalidDate = function() {
        return this._invalidDate
    }, ft.ordinal = function(e) {
        return this._ordinal.replace("%d", e)
    }, ft.preparse = yt, ft.postformat = yt, ft.relativeTime = function(e, a, t, s) {
        var n = this._relativeTime[t];
        return H(n) ? n(e, a, t, s) : n.replace(/%d/i, e)
    }, ft.pastFuture = function(e, a) {
    ...
    }, ft.months = function(e, a) {
        return e ? s(this._months) ? this._months[e.month()] : this._months[(this._months.isFormat || Oe).test(a) ? "format" : "standalone"][e.month()] : s(this._months) ? this._months : this._months.standalone
    }, ft.monthsShort = function(e, a) {
        return e ? s(this._monthsShort) ? this._monthsShort[e.month()] : this._monthsShort[Oe.test(a) ? "format" : "standalone"][e.month()] : s(this._monthsShort) ? this._monthsShort : this._monthsShort.standalone
    }, ft.monthsParse = function(e, a, t) {
        var s, n, d;
        if (this._monthsParseExact) return function(e, a, t) {
            ...
            return t ? "MMM" === a ? -1 !== (n = ve.call(this._shortMonthsParse, r)) ? n : null : -1 !== (n = ve.call(this._longMonthsParse, r)) ? n : null : "MMM" === a ? -1 !== (n = ve.call(this._shortMonthsParse, r)) ? n : -1 !== (n = ve.call(this._longMonthsParse, r)) ? n : null : -1 !== (n = ve.call(this._longMonthsParse, r)) ? n : -1 !== (n = ve.call(this._shortMonthsParse, r)) ? n : null
        }.call(this, e, a, t);
    ...
    }, ft.monthsRegex = function(e) {
        return this._monthsParseExact ? (o(this, "_monthsRegex") || Je.call(this), e ? this._monthsStrictRegex : this._monthsRegex) : (o(this, "_monthsRegex") || (this._monthsRegex = ze), this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex)
    }, ft.monthsShortRegex = function(e) {
        return this._monthsParseExact ? (o(this, "_monthsRegex") || Je.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (o(this, "_monthsShortRegex") || (this._monthsShortRegex = Fe), this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex)
    }, ft.week = function(e) {
        return Ie(e, this._week.dow, this._week.doy).week
    }, ft.firstDayOfYear = function() {
        return this._week.doy
    }, ft.firstDayOfWeek = function() {
        return this._week.dow
    }, ft.weekdays = function(e, a) {
    ...
    }, ft.weekdaysRegex = function(e) {
        return this._weekdaysParseExact ? (o(this, "_weekdaysRegex") || Qe.call(this), e ? this._weekdaysStrictRegex : this._weekdaysRegex) : (o(this, "_weekdaysRegex") || (this._weekdaysRegex = $e), this._weekdaysStrictRegex && e ? this._weekdaysStrictRegex : this._weekdaysRegex)
    }, ft.weekdaysShortRegex = function(e) {
        return this._weekdaysParseExact ? (o(this, "_weekdaysRegex") || Qe.call(this), e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (o(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Be), this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
    }, ft.weekdaysMinRegex = function(e) {
        return this._weekdaysParseExact ? (o(this, "_weekdaysRegex") || Qe.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (o(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = qe), this._weekdaysMinStrictRegex && e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
    }, ft.isPM = function(e) {
        return "p" === (e + "").toLowerCase().charAt(0)
    }, ft.meridiem = function(e, a, t) {
    ...
    }), t.lang = g("moment.lang is deprecated. Use moment.locale instead.", oa), t.langData = g("moment.langData is deprecated. Use moment.localeData instead.", ua);
    var Tt = Math.abs;
    ...
    function Bt() {
        ...
        if (!u) return "P0D";
        var l = u < 0 ? "-" : "",
            M = $t(this._months) !== $t(u) ? "-" : "",
            h = $t(this._days) !== $t(u) ? "-" : "",
            L = $t(this._milliseconds) !== $t(u) ? "-" : "";
    ...
    qt.isValid = function() {
        ...
        if ("month" === (e = P(e)) || "quarter" === e || "year" === e) switch (a = this._days + s / 864e5, t = this._months + vt(a), e) {
            case "month":
                return t;
            case "quarter":
                return t / 3;
    ...
    }, qt.asMilliseconds = bt, qt.asSeconds = jt, qt.asMinutes = xt, qt.asHours = Ot, qt.asDays = Pt, qt.asWeeks = Wt, qt.asMonths = At, qt.asQuarters = Et, qt.asYears = Ft, qt.valueOf = function() {
        ...
        var e, a, t, s, n, d = this._milliseconds,
            ...
            _ = this._months,
            i = this._data;
        return d >= 0 && r >= 0 && _ >= 0 || d <= 0 && r <= 0 && _ <= 0 || (d += 864e5 * wt(St(_) + r), r = 0, _ = 0), i.milliseconds = d % 1e3, e = p(d / 1e3), i.seconds = e % 60, a = p(e / 60), i.minutes = a % 60, t = p(a / 60), i.hours = t % 24, r += p(t / 24), _ += n = p(vt(r)), r -= wt(St(n)), s = p(_ / 12), _ %= 12, i.days = r, i.months = _, i.years = s, this
    }, qt.clone = function() {
        return Ga(this)
    }, qt.get = function(e) {
        return e = P(e), this.isValid() ? this[e + "s"]() : NaN
    }, qt.milliseconds = Jt, qt.seconds = Nt, qt.minutes = Rt, qt.hours = Ct, qt.days = It, qt.weeks = function() {
        return p(this.days() / 7)
    }, qt.months = Ut, qt.years = Gt, qt.humanize = function(e) {
        if (!this.isValid()) return this.localeData().invalidDate();
        var a = this.localeData(),
            t = function(e, a, t) {
                var s = Ga(e).abs(),
                    ...
                    i = Vt(s.as("M")),
                    o = Vt(s.as("y")),
                    m = n <= Kt.ss && ["s", n] || n < Kt.s && ["ss", n] || d <= 1 && ["m"] || d < Kt.m && ["mm", d] || r <= 1 && ["h"] || r < Kt.h && ["hh", r] || _ <= 1 && ["d"] || _ < Kt.d && ["dd", _] || i <= 1 && ["M"] || i < Kt.M && ["MM", i] || o <= 1 && ["y"] || ["yy", o];
    ...
    }, qt.toISOString = Bt, qt.toString = Bt, qt.toJSON = Bt, qt.locale = Xa, qt.localeData = at, qt.toIsoString = g("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Bt), qt.lang = et, C("X", 0, 0, "unix"), C("x", 0, 0, "valueOf"), ie("x", se), ie("X", /[+-]?\d+(\.\d{1,3})?/), le("X", function(e, a, t) {
        t._d = new Date(1e3 * parseFloat(e, 10))
    }), le("x", function(e, a, t) {
        t._d = new Date(k(e))
    }), t.version = "2.24.0", e = ba, t.fn = Yt, t.min = function() {
        ...
        return kt(e, a, "months")
    }, t.isDate = _, t.locale = oa, t.invalid = h, t.duration = Ga, t.isMoment = f, t.weekdays = function(e, a, t) {
        return Dt(e, a, t, "weekdays")
    }, t.parseZone = function() {
        return ba.apply(null, arguments).parseZone()
    }, t.localeData = ua, t.isDuration = Aa, t.monthsShort = function(e, a) {
        return kt(e, a, "monthsShort")
    }, t.weekdaysMin = function(e, a, t) {
        return Dt(e, a, t, "weekdaysMin")
    }, t.defineLocale = ma, t.updateLocale = function(e, a) {
        if (null != a) {
            var t, s, n = na;
            null != (s = ia(e)) && (n = s._config), (t = new j(a = b(n, a))).parentLocale = da[e], da[e] = t, oa(e)
        } else null != da[e] && (null != da[e].parentLocale ? da[e] = da[e].parentLocale : null != da[e] && delete da[e]);
        return da[e]
    }, t.locales = function() {
        return w(da)
        ...
        return void 0 === e ? Vt : "function" == typeof e && (Vt = e, !0)
    ...
    var Qt = {
        ...
        ts = ["يناير", "فبراير", "مارس", "أبريل", "مايو", "يونيو", "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"];
    ...
    t.defineLocale("az", {
        ...
        ordinal: function(e) {
            ...
            var a = e % 10;
            return e + (us[a] || us[e % 100 - a] || us[e >= 100 ? 100 : null])
        },
        week: {
            dow: 1,
            doy: 7
    ...
    var fs = "leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec".split("_"),
        ps = "led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro".split("_"),
        ks = [/^led/i, /^úno/i, /^bře/i, /^dub/i, /^kvě/i, /^(čvn|červen$|června)/i, /^(čvc|červenec|července)/i, /^srp/i, /^zář/i, /^říj/i, /^lis/i, /^pro/i],
        Ds = /^(leden|únor|březen|duben|květen|červenec|července|červen|června|srpen|září|říjen|listopad|prosinec|led|úno|bře|dub|kvě|čvn|čvc|srp|zář|říj|lis|pro)/i;
    ...
    function gs(e, a, t, s) {
        ...
        switch (t) {
            ...
            case "ss":
                return a || s ? n + (Ts(e) ? "sekundy" : "sekund") : n + "sekundami";
            case "m":
                return a ? "minuta" : s ? "minutu" : "minutou";
            case "mm":
                return a || s ? n + (Ts(e) ? "minuty" : "minut") : n + "minutami";
            case "h":
                return a ? "hodina" : s ? "hodinu" : "hodinou";
            case "hh":
                return a || s ? n + (Ts(e) ? "hodiny" : "hodin") : n + "hodinami";
            case "d":
                return a || s ? "den" : "dnem";
            case "dd":
                return a || s ? n + (Ts(e) ? "dny" : "dní") : n + "dny";
            case "M":
                return a || s ? "měsíc" : "měsícem";
            case "MM":
                return a || s ? n + (Ts(e) ? "měsíce" : "měsíců") : n + "měsíci";
            case "y":
                return a || s ? "rok" : "rokem";
            case "yy":
                return a || s ? n + (Ts(e) ? "roky" : "let") : n + "lety"
        }
    }
    ...
    var Hs = ["ޖެނުއަރީ", "ފެބްރުއަރީ", "މާރިޗު", "އޭޕްރީލު", "މޭ", "ޖޫން", "ޖުލައި", "އޯގަސްޓު", "ސެޕްޓެމްބަރު", "އޮކްޓޯބަރު", "ނޮވެމްބަރު", "ޑިސެމްބަރު"],
        bs = ["އާދިއްތަ", "ހޯމަ", "އަންގާރަ", "ބުދަ", "ބުރާސްފަތި", "ހުކުރު", "ހޮނިހިރު"];
    t.defineLocale("dv", {
        months: Hs,
        monthsShort: Hs,
        weekdays: bs,
    ...
    var zs = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split("_"),
        Js = "ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic".split("_"),
        Ns = [/^ene/i, /^feb/i, /^mar/i, /^abr/i, /^may/i, /^jun/i, /^jul/i, /^ago/i, /^sep/i, /^oct/i, /^nov/i, /^dic/i],
    ...
    t.defineLocale("es", {
        months: "enero_febrero_marzo_abril_mayo_junio_julio_agosto_septiembre_octubre_noviembre_diciembre".split("_"),
        monthsShort: function(e, a) {
            return e ? /-MMM-/.test(a) ? Js[e.month()] : zs[e.month()] : zs
        },
        monthsRegex: Rs,
        monthsShortRegex: Rs,
        monthsStrictRegex: /^(enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre)/i,
    ...
    var Gs = "nolla yksi kaksi kolme neljä viisi kuusi seitsemän kahdeksan yhdeksän".split(" "),
        Vs = ["nolla", "yhden", "kahden", "kolmen", "neljän", "viiden", "kuuden", Gs[7], Gs[8], Gs[9]];
    ...
    var tn = "vasárnap hétfőn kedden szerdán csütörtökön pénteken szombaton".split(" ");
    ...
    function nn(e) {
        return (e ? "" : "[múlt] ") + "[" + tn[this.day()] + "] LT[-kor]"
    }
    ...
    function rn(e, a, t, s) {
        ...
        switch (t) {
            ...
            case "ss":
                return dn(e) ? n + (a || s ? "sekúndur" : "sekúndum") : n + "sekúnda";
            case "m":
                return a ? "mínúta" : "mínútu";
            case "mm":
                return dn(e) ? n + (a || s ? "mínútur" : "mínútum") : a ? n + "mínúta" : n + "mínútu";
            case "hh":
                return dn(e) ? n + (a || s ? "klukkustundir" : "klukkustundum") : n + "klukkustund";
            case "d":
                return a ? "dagur" : s ? "dag" : "degi";
            case "dd":
                return dn(e) ? a ? n + "dagar" : n + (s ? "daga" : "dögum") : a ? n + "dagur" : n + (s ? "dag" : "degi");
            case "M":
                return a ? "mánuður" : s ? "mánuð" : "mánuði";
            case "MM":
                return dn(e) ? a ? n + "mánuðir" : n + (s ? "mánuði" : "mánuðum") : a ? n + "mánuður" : n + (s ? "mánuð" : "mánuði");
            case "y":
                return a || s ? "ár" : "ári";
            case "yy":
                return dn(e) ? n + (a || s ? "ár" : "árum") : n + (a || s ? "ár" : "ári")
        }
    }
    t.defineLocale("hu", {
        ...
        calendar: {
            ...
            nextWeek: function() {
                return nn.call(this, !0)
            },
            lastDay: "[tegnap] LT[-kor]",
            lastWeek: function() {
                return nn.call(this, !1)
            },
            sameElse: "L"
        },
        relativeTime: {
    ...
    t.defineLocale("kk", {
        ...
        ordinal: function(e) {
            return e + (_n[e] || _n[e % 10] || _n[e >= 100 ? 100 : null])
        },
        week: {
            dow: 1,
            doy: 7
    ...
    var Mn = {
        ...
        Ln = ["کانونی دووەم", "شوبات", "ئازار", "نیسان", "ئایار", "حوزەیران", "تەمموز", "ئاب", "ئەیلوول", "تشرینی یەكەم", "تشرینی دووەم", "كانونی یەکەم"];
    t.defineLocale("ku", {
        months: Ln,
        monthsShort: Ln,
    ...
    t.defineLocale("ky", {
        ...
        ordinal: function(e) {
            return e + (cn[e] || cn[e % 10] || cn[e >= 100 ? 100 : null])
        },
        week: {
            dow: 1,
            doy: 7
        ...
        relativeTime: {
            future: function(e) {
                return yn(e.substr(0, e.indexOf(" "))) ? "a " + e : "an " + e
            },
            past: function(e) {
                return yn(e.substr(0, e.indexOf(" "))) ? "viru " + e : "virun " + e
            },
            s: "e puer Sekonnen",
            ss: "%d Sekonnen",
            m: Yn,
    ...
    function pn(e, a, t, s) {
        return a ? Dn(t)[0] : s ? Dn(t)[1] : Dn(t)[2]
    }
    ...
    function Tn(e, a, t, s) {
        var n = e + " ";
        return 1 === e ? n + pn(0, a, t[0], s) : a ? n + (kn(e) ? Dn(t)[1] : Dn(t)[0]) : s ? n + Dn(t)[1] : n + (kn(e) ? Dn(t)[1] : Dn(t)[2])
    }
    t.defineLocale("lt", {
        months: {
    ...
    var Rn = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split("_"),
        ...
        In = [/^jan/i, /^feb/i, /^maart|mrt.?$/i, /^apr/i, /^mei$/i, /^jun[i.]?$/i, /^jul[i.]?$/i, /^aug/i, /^sep/i, /^okt/i, /^nov/i, /^dec/i],
        Un = /^(januari|februari|maart|april|mei|ju[nl]i|augustus|september|oktober|november|december|jan\.?|feb\.?|mrt\.?|apr\.?|ju[nl]\.?|aug\.?|sep\.?|okt\.?|nov\.?|dec\.?)/i;
    t.defineLocale("nl", {
        months: "januari_februari_maart_april_mei_juni_juli_augustus_september_oktober_november_december".split("_"),
        monthsShort: function(e, a) {
            return e ? /-MMM-/.test(a) ? Cn[e.month()] : Rn[e.month()] : Rn
        },
        monthsRegex: Un,
        monthsShortRegex: Un,
        monthsStrictRegex: /^(januari|februari|maart|april|mei|ju[nl]i|augustus|september|oktober|november|december)/i,
    ...
    var Kn = "styczeń_luty_marzec_kwiecień_maj_czerwiec_lipiec_sierpień_wrzesień_październik_listopad_grudzień".split("_"),
        Zn = "stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_września_października_listopada_grudnia".split("_");
    ...
    t.defineLocale("pl", {
        months: function(e, a) {
            return e ? "" === a ? "(" + Zn[e.month()] + "|" + Kn[e.month()] + ")" : /D MMMM/.test(a) ? Zn[e.month()] : Kn[e.month()] : Kn
        },
    ...
    var ed = ["جنوري", "فيبروري", "مارچ", "اپريل", "مئي", "جون", "جولاءِ", "آگسٽ", "سيپٽمبر", "آڪٽوبر", "نومبر", "ڊسمبر"],
        ad = ["آچر", "سومر", "اڱارو", "اربع", "خميس", "جمع", "ڇنڇر"];
    t.defineLocale("sd", {
        months: ed,
        monthsShort: ed,
        weekdays: ad,
    ...
    var td = "január_február_marec_apríl_máj_jún_júl_august_september_október_november_december".split("_"),
        sd = "jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec".split("_");
    ...
    function dd(e, a, t, s) {
        ...
        switch (t) {
            ...
            case "ss":
                return a || s ? n + (nd(e) ? "sekundy" : "sekúnd") : n + "sekundami";
            case "m":
                return a ? "minúta" : s ? "minútu" : "minútou";
            case "mm":
                return a || s ? n + (nd(e) ? "minúty" : "minút") : n + "minútami";
            case "h":
                return a ? "hodina" : s ? "hodinu" : "hodinou";
            case "hh":
                return a || s ? n + (nd(e) ? "hodiny" : "hodín") : n + "hodinami";
            case "d":
                return a || s ? "deň" : "dňom";
            case "dd":
                return a || s ? n + (nd(e) ? "dni" : "dní") : n + "dňami";
            case "M":
                return a || s ? "mesiac" : "mesiacom";
            case "MM":
                return a || s ? n + (nd(e) ? "mesiace" : "mesiacov") : n + "mesiacmi";
            case "y":
                return a || s ? "rok" : "rokom";
            case "yy":
                return a || s ? n + (nd(e) ? "roky" : "rokov") : n + "rokmi"
        }
    }
    ...
    var _d = {
        ...
        translate: function(e, a, t) {
            var s = _d.words[t];
            return 1 === t.length ? a ? s[0] : s[1] : e + " " + _d.correctGrammaticalCase(e, s)
        }
    };
    ...
    var id = {
        ...
        translate: function(e, a, t) {
            var s = id.words[t];
            return 1 === t.length ? a ? s[0] : s[1] : e + " " + id.correctGrammaticalCase(e, s)
        }
    };
    t.defineLocale("sr", {
        months: "januar_februar_mart_april_maj_jun_jul_avgust_septembar_oktobar_novembar_decembar".split("_"),
    ...
    t.defineLocale("tg", {
        ...
        ordinal: function(e) {
            return e + (ud[e] || ud[e % 10] || ud[e >= 100 ? 100 : null])
        },
        week: {
            dow: 1,
            doy: 7
    ...
    var ld = "pagh_wa’_cha’_wej_loS_vagh_jav_Soch_chorgh_Hut".split("_");
        ...
        ordinal: function(e, a) {
            switch (a) {
                ...
                default:
                    if (0 === e) return e + "'ıncı";
                    var t = e % 10;
                    return e + (hd[t] || hd[e % 100 - t] || hd[e >= 100 ? 100 : null])
            }
        },
        week: {
            dow: 1,
        ...
        calendar: {
            ...
            lastWeek: function() {
                switch (this.day()) {
                    ...
                    case 5:
                    case 6:
                        return Yd("[Минулої] dddd [").call(this);
                    case 1:
                    case 2:
                    case 4:
                        return Yd("[Минулого] dddd [").call(this)
                }
            },
            sameElse: "L"
        },
    ...
    var yd = ["جنوری", "فروری", "مارچ", "اپریل", "مئی", "جون", "جولائی", "اگست", "ستمبر", "اکتوبر", "نومبر", "دسمبر"],
        fd = ["اتوار", "پیر", "منگل", "بدھ", "جمعرات", "جمعہ", "ہفتہ"];
