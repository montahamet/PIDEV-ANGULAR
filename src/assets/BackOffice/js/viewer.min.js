(function(global, factory) {
        ...
        if (data && isFunction(callback)) {
            if (Array.isArray(data) || isNumber(data.length)) {
                ...
                for (i = 0; i < length; i += 1) {
                    if (callback.call(data, data[i], i, data) === !1) {
                        break
                    }
                }
    ...
    var handlers = {
        ...
        pointerdown: function pointerdown(e) {
            ...
            var action = options.movable ? ACTION_MOVE : !1;
        ...
        pointermove: function pointermove(e) {
            ...
            if (e.changedTouches) {
                ...
                assign(pointers[e.pointerId || 0], getPointer(e, !0))
            }
        ...
        wheel: function wheel(e) {
            ...
            this.zoom(-delta * ratio, !0, e)
        }
    };
    var methods = {
        show: function show() {
            var immediate = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !1;
            var element = this.element,
                options = this.options;
            ...
            if (dispatchEvent(element, EVENT_SHOW) === !1 || !this.ready) {
                return this
            }
            if (this.hiding) {
        ...
        hide: function hide() {
            ...
            if (dispatchEvent(element, EVENT_HIDE) === !1) {
                return this
            }
            if (this.showing) {
                this.transitioning.abort()
        ...
        prev: function prev() {
            var loop = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !1;
        ...
        zoom: function zoom(ratio) {
            var hasTooltip = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : !1;
        ...
        zoomTo: function zoomTo(ratio) {
            var hasTooltip = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : !1;
            var _originalEvent = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
            var _zoomable = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : !1;
            var options = this.options,
                pointers = this.pointers,
                imageData = this.imageData;
        ...
        play: function play() {
            var _this2 = this;
            var fullscreen = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !1;
    ...
    var others = {
        ...
        shown: function shown() {
            ...
            if (dispatchEvent(element, EVENT_SHOWN) === !1) {
                return
            }
        ...
        change: function change(e) {
            ...
            switch (this.action) {
                case ACTION_MOVE:
                    ...
                    break;
                case ACTION_ZOOM:
                    this.zoom(getMaxZoomRatio(pointers), !1, e);
                    break;
                case ACTION_SWITCH:
        ...
        createClass(Viewer, [{
            ...
            value: function build() {
                ...
                if (options.backdrop) {
                    ...
                    if (!options.inline && options.backdrop === !0) {
                ...
                if (dispatchEvent(element, EVENT_READY) === !1) {
                    this.ready = !1;
                    return
                }
